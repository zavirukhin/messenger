export enum ErrorCode {
  ...
  INSUFFICIENT_PERMISSIONS_DELETE_USER_FROM_CHAT = 'INSUFFICIENT_PERMISSIONS_DELETE_USER_FROM_CHAT',
  USER_ALREADY_IN_CHAT = 'USER_ALREADY_IN_CHAT',
  INSUFFICIENT_PERMISSIONS_ADD_USER_TO_CHAT = 'INSUFFICIENT_PERMISSIONS_ADD_USER_TO_CHAT',
  CANNOT_REMOVE_SELF_FROM_CHAT = 'CANNOT_REMOVE_SELF_FROM_CHAT',
}
